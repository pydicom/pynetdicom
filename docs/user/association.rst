...
::
    ...
    assoc = ae.associate("localhost", 11112, ae_title='STORE_SCP')
...
::
    ...
    assoc = ae.associate("localhost", 11112, contexts=requested_contexts)
...
.. code-block:: python
    ...
    # Associate with the peer at IP address 127.0.0.1 and port 11112
    assoc = ae.associate("localhost", 11112, ext_neg=negotiation_items)
...
::
    ...
    assoc = ae.associate("localhost", 11112, tls_args=(ssl_cx, None))
...
::
    ...
    # Blocks
    ae.start_server(("localhost", 11113), block=True)
...
::
    ...
    ae.start_server(("localhost", 11112), ae_title='STORE_SCP')
...
::
    ...
    ae.start_server(("localhost", 11112), contexts=supported_cx)
...
::
    ...
    server = ae.start_server(("localhost", 11112), block=False, ssl_context=ssl_cx)
