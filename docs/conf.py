...
version = pynetdicom3.__version__
# The full version, including alpha/beta/rc tags.
release = pynetdicom3.__version__
...
# Custom style
html_style = 'css/pynetdicom3.css'
...
latex_documents = [
  ('index', 'pynetdicom3.tex', u'pynetdicom3 Documentation',
   u'pynetdicom3 contributors', 'manual'),
]
