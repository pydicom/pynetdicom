...
class TestPrimitive_SCP_SCU_RoleSelectionNegotiation(unittest.TestCase):
    ...
    def test_conversion(self):
        ...
        assert item.encode() == (
            b'\x54\x00\x00\x1e\x00\x1a\x31\x2e\x32\x2e\x38\x34\x30\x2e\x31\x30'
...
class TestPrimitive_SOPClassCommonExtendedNegotiation(object):
    ...
    def test_conversion(self):
        ...
        assert item.encode() == (
            b'\x57\x00\x00\x52'
            b'\x00\x1a\x31\x2e\x32\x2e\x38\x34\x30\x2e\x31\x30'
            ...
            b'\x34\x2e\x32\x00'
            b'\x00\x20\x00\x1e\x31\x2e\x32\x2e\x38\x34\x30\x2e\x31\x30'
